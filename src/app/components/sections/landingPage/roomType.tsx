...
const RoomType = () => {
    ...
    return (
        <section id={'room'} className="w-full h-[75vh] md:h-[80vh] lg:h-screen py-12 sm:py-16 md:py-20 flex flex-col gap-8 sm:gap-10 md:gap-12 justify-center items-center bg-lightGreen">
