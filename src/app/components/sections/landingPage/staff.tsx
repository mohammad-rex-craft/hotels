            ...
            <div className={'flex flex-col w-full bg-darkGreen gap-3 sm:gap-4  items-center pt-10 lg:pt-16 h-[65%] lg:h-[60%] relative'}>
                ...
                <div
                    className={'w-full h-[70%] md:h-full absolute -bottom-[31%] md:-bottom-[44%] left-1/2 -translate-x-1/2 z-10 flex gap-6 justify-center '}>
                        ...
                        {data.map((e,index)=>{
                            return (
                                <div className={'w-[18%] lg:w-[16%] h-[80%]'} key={index}>
                                    <img className={'w-full h-[70%] rounded-t-2xl'}
                                         src={e.img}
                                         alt={'..'}></img>
                                    <div className={'w-full h-[30%] rounded-b-2xl flex flex-col justify-center px-2 lg:px-6'}
                                         style={{boxShadow: "0 6.5px 19px 12px #d1d0d0"}}>
                                        <h3 className={'text-[9px] md:text-[12px] lg:text-[16px]'}>{e.name}</h3>
                                        <p>{e.employee}</p>
                                    </div>
                                </div>
                            )
